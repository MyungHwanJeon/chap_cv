...
\begin{pubSubsection}{International Journal}
  ...
  \item Hyeonjae Gil, \underline{\textbf{Myung-Hwan Jeon}}, and Ayoung Kim, “Fieldscale: Locality-Aware Field-based Adaptive Rescaling for Thermal Infrared Image”, in IEEE Robotics and Automation Letters (RA-L), 2024.
...
\begin{pubSubsection}{International Conference}
  ...
  \item Chaehyeon Song, Jaeho Shin, \underline{\textbf{Myung-Hwan Jeon}}, Jongwoo Lim, and Ayoung Kim, “Unbiased Estimator for Distorted Conic in Camera Calibration”, in IEEE/CVF Conference on Computer Vision and Pattern (CVPR), 2024.
